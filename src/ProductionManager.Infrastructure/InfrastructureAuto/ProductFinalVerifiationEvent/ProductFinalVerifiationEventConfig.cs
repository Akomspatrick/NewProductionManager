...
{
    public class ProductFinalVerifiationEventConfig : IEntityTypeConfiguration<ProductFinalVerifiationEvent>
    {
        public void Configure(EntityTypeBuilder<ProductFinalVerifiationEvent> entity)
        {
            ...
            entity.Property(e => e.PercentNonlinearity).HasPrecision(18,6); 
            ...
            entity.HasOne<Tester>(e => e.Tester).WithMany(ad => ad.ProductFinalVerifiationEvents).HasForeignKey(e => new {e.TesterName});
        }
    }
}