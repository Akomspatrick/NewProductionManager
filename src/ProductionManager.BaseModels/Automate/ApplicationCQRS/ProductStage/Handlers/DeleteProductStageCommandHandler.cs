...
namespace ProductionManager.Application.CQRS
{
    public  class DeleteProductStageCommandHandler  :  IRequestHandler<DeleteProductStageCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<DeleteProductStageCommandHandler> _logger;
        public DeleteProductStageCommandHandler(IUnitOfWork unitOfWork, IAppLogger<DeleteProductStageCommandHandler> logger)
        {
