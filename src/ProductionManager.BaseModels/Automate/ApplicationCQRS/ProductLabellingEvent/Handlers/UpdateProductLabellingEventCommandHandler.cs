...
namespace ProductionManager.Application.CQRS
{
    public  class UpdateProductLabellingEventCommandHandler  :  IRequestHandler<UpdateProductLabellingEventCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<UpdateProductLabellingEventCommandHandler> _logger;
        public UpdateProductLabellingEventCommandHandler(IUnitOfWork unitOfWork, IAppLogger<UpdateProductLabellingEventCommandHandler> logger)
        {
