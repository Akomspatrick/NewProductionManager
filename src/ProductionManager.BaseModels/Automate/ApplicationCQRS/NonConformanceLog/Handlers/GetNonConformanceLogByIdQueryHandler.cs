...
namespace ProductionManager.Application.CQRS
{
    public  class GetNonConformanceLogByIdQueryHandler  :  IRequestHandler<GetNonConformanceLogByIdQuery, Either<GeneralFailure, NonConformanceLogResponseDTO>>
    {
        ...
        private readonly IAppLogger<GetNonConformanceLogByIdQueryHandler> _logger;
        public GetNonConformanceLogByIdQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetNonConformanceLogByIdQueryHandler> logger)
        {
