...
namespace ProductionManager.Application.CQRS
{
    public  class UpdateLogSummaryCommandHandler  :  IRequestHandler<UpdateLogSummaryCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<UpdateLogSummaryCommandHandler> _logger;
        public UpdateLogSummaryCommandHandler(IUnitOfWork unitOfWork, IAppLogger<UpdateLogSummaryCommandHandler> logger)
        {
