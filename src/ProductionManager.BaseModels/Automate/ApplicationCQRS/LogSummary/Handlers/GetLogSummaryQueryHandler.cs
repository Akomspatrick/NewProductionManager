...
namespace ProductionManager.Application.CQRS
{
    public  class GetLogSummaryQueryHandler  :  IRequestHandler<GetLogSummaryQuery, Either<GeneralFailure, LogSummaryResponseDTO>>
    {
        ...
        private readonly IAppLogger<GetLogSummaryQueryHandler> _logger;
        public GetLogSummaryQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetLogSummaryQueryHandler> logger)
        {
