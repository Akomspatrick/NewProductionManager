...
namespace ProductionManager.Application.CQRS
{
    public  class GetProductReceptionEventByIdQueryHandler  :  IRequestHandler<GetProductReceptionEventByIdQuery, Either<GeneralFailure, ProductReceptionEventResponseDTO>>
    {
        ...
        private readonly IAppLogger<GetProductReceptionEventByIdQueryHandler> _logger;
        public GetProductReceptionEventByIdQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetProductReceptionEventByIdQueryHandler> logger)
        {
