...
namespace ProductionManager.Application.CQRS
{
    public  class GetAllProductReceptionEventQueryHandler  :  IRequestHandler<GetAllProductReceptionEventQuery, Either<GeneralFailure, IEnumerable<ProductReceptionEventResponseDTO>>>
    {
        ...
        private readonly IAppLogger<GetAllProductReceptionEventQueryHandler> _logger;
        public GetAllProductReceptionEventQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetAllProductReceptionEventQueryHandler> logger)
        {
