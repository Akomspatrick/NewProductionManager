...
namespace ProductionManager.Application.CQRS
{
    public  class GetAllProductInventoryEventQueryHandler  :  IRequestHandler<GetAllProductInventoryEventQuery, Either<GeneralFailure, IEnumerable<ProductInventoryEventResponseDTO>>>
    {
        ...
        private readonly IAppLogger<GetAllProductInventoryEventQueryHandler> _logger;
        public GetAllProductInventoryEventQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetAllProductInventoryEventQueryHandler> logger)
        {
