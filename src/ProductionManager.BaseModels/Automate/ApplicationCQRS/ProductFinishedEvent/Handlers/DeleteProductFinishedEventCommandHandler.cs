...
namespace ProductionManager.Application.CQRS
{
    public  class DeleteProductFinishedEventCommandHandler  :  IRequestHandler<DeleteProductFinishedEventCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<DeleteProductFinishedEventCommandHandler> _logger;
        public DeleteProductFinishedEventCommandHandler(IUnitOfWork unitOfWork, IAppLogger<DeleteProductFinishedEventCommandHandler> logger)
        {
