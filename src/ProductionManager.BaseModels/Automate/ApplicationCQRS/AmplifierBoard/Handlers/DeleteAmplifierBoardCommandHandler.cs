...
namespace ProductionManager.Application.CQRS
{
    public  class DeleteAmplifierBoardCommandHandler  :  IRequestHandler<DeleteAmplifierBoardCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<DeleteAmplifierBoardCommandHandler> _logger;
        public DeleteAmplifierBoardCommandHandler(IUnitOfWork unitOfWork, IAppLogger<DeleteAmplifierBoardCommandHandler> logger)
        {
