...
namespace ProductionManager.Application.CQRS
{
    public  class UpdateProductCertificateCommandHandler  :  IRequestHandler<UpdateProductCertificateCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<UpdateProductCertificateCommandHandler> _logger;
        public UpdateProductCertificateCommandHandler(IUnitOfWork unitOfWork, IAppLogger<UpdateProductCertificateCommandHandler> logger)
        {
