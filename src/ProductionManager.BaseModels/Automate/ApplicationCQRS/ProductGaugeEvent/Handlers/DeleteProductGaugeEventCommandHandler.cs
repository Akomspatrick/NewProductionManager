...
namespace ProductionManager.Application.CQRS
{
    public  class DeleteProductGaugeEventCommandHandler  :  IRequestHandler<DeleteProductGaugeEventCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<DeleteProductGaugeEventCommandHandler> _logger;
        public DeleteProductGaugeEventCommandHandler(IUnitOfWork unitOfWork, IAppLogger<DeleteProductGaugeEventCommandHandler> logger)
        {
