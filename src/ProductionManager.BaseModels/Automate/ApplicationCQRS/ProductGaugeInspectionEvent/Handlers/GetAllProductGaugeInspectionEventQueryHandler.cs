...
namespace ProductionManager.Application.CQRS
{
    public  class GetAllProductGaugeInspectionEventQueryHandler  :  IRequestHandler<GetAllProductGaugeInspectionEventQuery, Either<GeneralFailure, IEnumerable<ProductGaugeInspectionEventResponseDTO>>>
    {
        ...
        private readonly IAppLogger<GetAllProductGaugeInspectionEventQueryHandler> _logger;
        public GetAllProductGaugeInspectionEventQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetAllProductGaugeInspectionEventQueryHandler> logger)
        {
