...
namespace ProductionManager.Application.CQRS
{
    public  class DeleteProductGaugeInspectionEventCommandHandler  :  IRequestHandler<DeleteProductGaugeInspectionEventCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<DeleteProductGaugeInspectionEventCommandHandler> _logger;
        public DeleteProductGaugeInspectionEventCommandHandler(IUnitOfWork unitOfWork, IAppLogger<DeleteProductGaugeInspectionEventCommandHandler> logger)
        {
