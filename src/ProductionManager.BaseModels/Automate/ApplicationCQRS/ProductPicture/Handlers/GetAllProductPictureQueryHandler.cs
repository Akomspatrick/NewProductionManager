...
namespace ProductionManager.Application.CQRS
{
    public  class GetAllProductPictureQueryHandler  :  IRequestHandler<GetAllProductPictureQuery, Either<GeneralFailure, IEnumerable<ProductPictureResponseDTO>>>
    {
        ...
        private readonly IAppLogger<GetAllProductPictureQueryHandler> _logger;
        public GetAllProductPictureQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetAllProductPictureQueryHandler> logger)
        {
