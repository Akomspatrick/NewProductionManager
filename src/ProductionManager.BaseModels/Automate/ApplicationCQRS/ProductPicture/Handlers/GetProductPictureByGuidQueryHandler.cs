...
namespace ProductionManager.Application.CQRS
{
    public  class GetProductPictureByGuidQueryHandler  :  IRequestHandler<GetProductPictureByGuidQuery, Either<GeneralFailure, ProductPictureResponseDTO>>
    {
        ...
        private readonly IAppLogger<GetProductPictureByGuidQueryHandler> _logger;
        public GetProductPictureByGuidQueryHandler(IUnitOfWork unitOfWork, IAppLogger<GetProductPictureByGuidQueryHandler> logger)
        {
