...
namespace ProductionManager.Application.CQRS
{
    public  class DeleteProductAdditionalInfoCommandHandler  :  IRequestHandler<DeleteProductAdditionalInfoCommand, Either<GeneralFailure, int>>
    {
        ...
        private readonly IAppLogger<DeleteProductAdditionalInfoCommandHandler> _logger;
        public DeleteProductAdditionalInfoCommandHandler(IUnitOfWork unitOfWork, IAppLogger<DeleteProductAdditionalInfoCommandHandler> logger)
        {
