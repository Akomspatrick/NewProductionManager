...
namespace ProductionManager.Domain.Interfaces
{
    public interface IUnitOfWork : IDisposable
    {
        ...
        IMassfussionFunctionRepository MassfussionFunctionRepository { get; }
        IMassLoadApplicationRepository MassLoadApplicationRepository { get; }
        IRefreshTokenRepository RefreshTokenRepository { get; }
        IUsersGroupRepository UsersGroupRepository { get; }
