...
namespace ProductionManager.Application.CQRS
{
    public  class GetReferenceStandardByGuidQueryHandler  :  IRequestHandler<GetReferenceStandardByGuidQuery, Either<GeneralFailure, ReferenceStandardResponseDTO>>
    {
        ...
        private readonly ILogger<GetReferenceStandardByGuidQueryHandler> _logger;
        public IReferenceStandardRepository _referenceStandardRepository ;
        public GetReferenceStandardByGuidQueryHandler(IUnitOfWork unitOfWork, ILogger<GetReferenceStandardByGuidQueryHandler> logger, IReferenceStandardRepository referenceStandardRepository )
        {
