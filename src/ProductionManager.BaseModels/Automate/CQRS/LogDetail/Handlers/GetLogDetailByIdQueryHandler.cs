...
namespace ProductionManager.Application.CQRS
{
    public  class GetLogDetailByIdQueryHandler  :  IRequestHandler<GetLogDetailByIdQuery, Either<GeneralFailure, LogDetailResponseDTO>>
    {
        ...
        private readonly ILogger<GetLogDetailByIdQueryHandler> _logger;
        public ILogDetailRepository _logDetailRepository ;
        public GetLogDetailByIdQueryHandler(IUnitOfWork unitOfWork, ILogger<GetLogDetailByIdQueryHandler> logger, ILogDetailRepository logDetailRepository )
        {
