...
namespace ProductionManager.Application.CQRS
{
    public  class GetProductLabellingEventByGuidQueryHandler  :  IRequestHandler<GetProductLabellingEventByGuidQuery, Either<GeneralFailure, ProductLabellingEventResponseDTO>>
    {
        ...
        private readonly ILogger<GetProductLabellingEventByGuidQueryHandler> _logger;
        public IProductLabellingEventRepository _productLabellingEventRepository ;
        public GetProductLabellingEventByGuidQueryHandler(IUnitOfWork unitOfWork, ILogger<GetProductLabellingEventByGuidQueryHandler> logger, IProductLabellingEventRepository productLabellingEventRepository )
        {
