...
namespace ProductionManager.Application.CQRS
{
    public  class GetProductInitialUnitByGuidQueryHandler  :  IRequestHandler<GetProductInitialUnitByGuidQuery, Either<GeneralFailure, ProductInitialUnitResponseDTO>>
    {
        ...
        private readonly ILogger<GetProductInitialUnitByGuidQueryHandler> _logger;
        public IProductInitialUnitRepository _productInitialUnitRepository ;
        public GetProductInitialUnitByGuidQueryHandler(IUnitOfWork unitOfWork, ILogger<GetProductInitialUnitByGuidQueryHandler> logger, IProductInitialUnitRepository productInitialUnitRepository )
        {
