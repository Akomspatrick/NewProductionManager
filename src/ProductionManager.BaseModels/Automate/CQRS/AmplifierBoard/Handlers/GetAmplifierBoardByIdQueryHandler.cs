...
namespace ProductionManager.Application.CQRS
{
    public  class GetAmplifierBoardByIdQueryHandler  :  IRequestHandler<GetAmplifierBoardByIdQuery, Either<GeneralFailure, AmplifierBoardResponseDTO>>
    {
        ...
        private readonly ILogger<GetAmplifierBoardByIdQueryHandler> _logger;
        public IAmplifierBoardRepository _amplifierBoardRepository ;
        public GetAmplifierBoardByIdQueryHandler(IUnitOfWork unitOfWork, ILogger<GetAmplifierBoardByIdQueryHandler> logger, IAmplifierBoardRepository amplifierBoardRepository )
        {
